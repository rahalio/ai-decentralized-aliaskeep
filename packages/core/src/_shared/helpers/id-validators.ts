...
export const ZodVltId = createDomainIdValidator('vlt', 'Vault ID');
export const ZodLnkId = createDomainIdValidator('lnk', 'Link grant ID');
export const ZodErsId = createDomainIdValidator('ers', 'Erasure ID');
export const ZodClsId = createDomainIdValidator('cls', 'Classification scan ID');
export const ZodPrtId = createDomainIdValidator('prt', 'Participant ID');
export const ZodFabId = createDomainIdValidator('fab', 'Fabric profile ID');
export const ZodRptId = createDomainIdValidator('rpt', 'Report job ID');
export const ZodPolId = createDomainIdValidator('pol', 'Link policy ID');
export const ZodCrtId = createDomainIdValidator('crt', 'Certificate ID');
export const ZodQtnId = createDomainIdValidator('qtn', 'Quarantine ID');
export const ZodPsnId = createDomainIdValidator('psn', 'Pseudonym ID');
export const ZodCnsId = createDomainIdValidator('cns', 'Consortium ID');
