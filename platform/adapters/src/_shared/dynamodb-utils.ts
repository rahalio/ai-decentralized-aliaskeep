 ...
 *
 * @returns The core table name (e.g., "aliaskeep-core-dev")
 ...
 *
 * @returns The base table name (e.g., "aliaskeep-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "aliaskeep-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "aliaskeep-app-realtime-dev")
