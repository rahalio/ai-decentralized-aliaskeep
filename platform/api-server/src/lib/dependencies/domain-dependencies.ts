...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/classification\//, domain: "classification" },
  { pattern: /\/erasures\//, domain: "erasures" },
  { pattern: /\/fabric\//, domain: "fabric" },
  { pattern: /\/identity\//, domain: "identity" },
  { pattern: /\/links\//, domain: "links" },
...
export async function injectDomainDependencies(
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      case "classification":
        domainDeps = buildClassificationDomainModule(dynamoClient);
        break;
      case "erasures":
        domainDeps = buildErasuresDomainModule(dynamoClient);
        break;
      case "fabric":
        domainDeps = buildFabricDomainModule(dynamoClient);
        break;
      case "identity":
        domainDeps = buildIdentityDomainModule(dynamoClient);
        break;
      case "links":
        domainDeps = buildLinksDomainModule(dynamoClient);
        break;
      case "participants":
...
export interface DomainDependencies {
  classification: ClassificationDomainModule;
  erasures: ErasuresDomainModule;
  fabric: FabricDomainModule;
  identity: IdentityDomainModule;
  links: LinksDomainModule;
 ...
 */
export function getClassificationDeps(
  request: FastifyRequest,
): DomainDependencies["classification"] {
  return getDomainDeps(request, "classification");
}
...
export function getFabricDeps(
  request: FastifyRequest,
): DomainDependencies["fabric"] {
  return getDomainDeps(request, "fabric");
}
...
export function getLinksDeps(
  request: FastifyRequest,
): DomainDependencies["links"] {
  return getDomainDeps(request, "links");
}
